...
public class EscPosPrinterCommands {
    ...
    public static final byte[] DEFAULT_LINE_SPACING_0 = {0x1b, 0x32, 0};

    public static final byte[] LINE_SPACING_24 = {0x1b, 0x33, 0};
    public static final byte[] LINE_SPACING_30 = {0x1b, 0x33, 0};
    ...
    public EscPosPrinterCommands reset() {
        ...
        this.printerConnection.write(EscPosPrinterCommands.DEFAULT_LINE_SPACING_0);
        return this;
    }
